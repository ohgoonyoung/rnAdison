...
import com.rnadison.adison.AdisonAppPackage;
      ...
      new ReactNativeHost(this) {
        ...
        protected List<ReactPackage> getPackages() {
          ...
          // packages.add(new MyReactNativePackage());
            packages.add(new AdisonAppPackage());
          return packages;
        }
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.rnadison.ReactNativeFlipper");
        aClass
